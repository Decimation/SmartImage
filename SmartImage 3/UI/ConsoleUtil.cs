...
internal static class ConsoleUtil
{
	...
	{
		IntPtr sysMenu = Native.GetSystemMenu(ConsoleUtil.HndWindow, false);
	...
	internal static void SetConsoleMode()
	{
		...
		Native.GetConsoleMode(ConsoleUtil.StdIn, out ConsoleModes lpMode);

		ConsoleUtil._oldMode = lpMode;

		Native.SetConsoleMode(ConsoleUtil.StdIn, lpMode | ((ConsoleModes.ENABLE_MOUSE_INPUT &
