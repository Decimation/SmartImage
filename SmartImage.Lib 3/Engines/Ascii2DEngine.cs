...
public sealed class Ascii2DEngine : WebContentSearchEngine
{
	...
	protected override Url GetRawUri(SearchQuery query)
	{
	...
	protected IFlurlResponse GetResultOrigin(SearchQuery query, CancellationToken? c = null)
	{
