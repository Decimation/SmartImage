...
public sealed class TinEyeEngine : BaseSearchEngine
{
	...
	public const string API_URL = "https://tineye.com/api/v1/result_json/?sort=score&order=desc";
	...
	public override async Task<SearchResult> GetResultAsync(SearchQuery query, CancellationToken token = default)
	{
		...
		var res  = await req.GetStreamAsync();
		var teye = JsonSerializer.Deserialize<TinEyeRoot>(res);
